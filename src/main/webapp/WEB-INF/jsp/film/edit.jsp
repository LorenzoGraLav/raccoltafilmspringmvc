		...
		<div class="container">
			...
			<div class='card'>
				...
				<div class='card-body'>
					...
					<form:form method="post" modelAttribute="edit_film_attr"
						action="${pageContext.request.contextPath}/film/update"
						...
						<input type="hidden" value="${edit_film_attr.id}" name="id"></input>

						<div class="col-md-6">
							<label for="registaSearchInput" class="form-label">Regista:
								<span class="text-danger">*</span>
							</label>
							<spring:bind path="regista">
								<input class="form-control ${status.error ? 'is-invalid' : ''}"
									type="text" id="registaSearchInput" name="registaInput"
									value="${edit_film_attr.regista.nome}${empty edit_film_attr.regista.nome?'':' '}${edit_film_attr.regista.cognome}">
							</spring:bind>
							<input type="hidden" name="regista.id" id="registaId"
								value="${edit_film_attr.regista.id}">
